                ...
                <form id="form" class="form_Wjg689O" autocomplete="off">
                    ...
                    <div class="div_K61fxc9">
                        <div class="div_RRjPQLY">
                            ...
                            <div id="containerImageElement" class="div_Iaf1Qwz"  ${ add ? 'style="display:none"' : '' }>
    ...
    form.addEventListener('submit', e => {
        ...
        const dataAddUpdate =()=>{
            if(add) { 
                ...
                datapi.post(api(`/api/producto?${ paramQueries(queries) }`), data)
                    .then(res => {
                        console.log(res);
                ...
                datapi.patch(api(`/api/producto?${ paramQueries(queries) }`), data)
                    .then(res => {
