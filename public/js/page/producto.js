...
export default ({ filter = false, from = null, hash = '/store' } = {})=>{
    ...
    const ElementComponent = ele.create(`
        <div class="div_HsRtEhf icon-svg">
            <header class="header_139jCpa">
                ...
                <div class="div_ttL4BFL">
                    <button class="pointer" id="open_search">${ Icon.get('fi fi-rr-search') }</button>
    ...
    const { elementItem, elementItemData, open_search, elementItemLoader, buttonOpenFormAdd } = element
